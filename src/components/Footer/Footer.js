...
const Footer = () => {
  return (
    <footer>
      <section className=" bg-footer-top py-7 ">
        <div className=" flex-col items-center  justify-items-center  max-w-5xl  mx-auto">
          <h1 className=" text-2xl  font-extrabold p-8 text-center">
          ...
          <div className=" flex  items-center justify-around">
            {FOOTER_BULLET_DATA.map(({ id, name, icon, text, span }) => {
              return (
                <div
                  className=" flex  items-center  justify-items-center  max-w-5xl  "
                  key={id}
                >
                  <div className=" flex items-center  w-96">
                    <i className={`${icon}  text-4xl p-7`} />
      ...
      <section className=" bg-footer-bottom">
        <div className=" flex-col items-center  justify-items-center  max-w-5xl  mx-auto"></div>
      </section>
    </footer>
  );
};
